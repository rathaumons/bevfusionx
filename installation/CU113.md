...
- Install custom [`cumm`](https://github.com/FindDefinition/cumm.git) and [`spconv`](https://github.com/traveller59/spconv.git) with CUDA 11.3:

  ```bash
  export CUMM_CUDA_VERSION="11.3"
  export CUMM_CUDA_ARCH_LIST="7.5;8.6"  # optional for direct install
