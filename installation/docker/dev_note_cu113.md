...
- Install [MMCV v1.7.3](https://github.com/rathaROG/mmcv/releases/tag/v1.7.3-bevfusionx) with CUDA:
  ...
  - Config cmake, build, and install:
    ...
    ```bash
    cd mmcv
    export TORCH_CUDA_ARCH_LIST="7.5;8.6"  # Use nvidia-arch for better control -> https://github.com/rathaROG/nvidia-arch
...
- Install custom [`cumm`](https://github.com/rathaROG/cumm-gpu) and [`spconv`](https://github.com/rathaROG/spconv-gpu) with CUDA 11.3:
  ...
  pip install git+https://github.com/rathaROG/spconv-gpu.git@v2.4.0 --ignore-requires-python --no-deps --no-build-isolation
  ```
