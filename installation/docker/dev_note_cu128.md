...
- Pull the [official NVIDIA CUDA 12.8.1](https://hub.docker.com/layers/nvidia/cuda/12.8.1-cudnn-devel-ubuntu20.04) on host:

  ```bash
  docker pull nvidia/cuda:12.8.1-cudnn-devel-ubuntu20.04
  ```
