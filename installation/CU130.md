# [Installation](../installation/) · [CUDA 13.0] · 🆕
...
- Only [CUDA 13.0](https://docs.nvidia.com/cuda/cuda-installation-guide-linux/) & [cuDNN 9.x](https://docs.nvidia.com/deeplearning/cudnn/latest/installation/linux.html)
